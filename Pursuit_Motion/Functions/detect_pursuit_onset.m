...
%Input : velocity vector of trial, target speed, and moment of movement
%onset
...
% threshold and stays there for 50 consecutive samples
...
Flag = 0;
Begin = Start+25; % Minimum start point 25 ms after the target movement onset

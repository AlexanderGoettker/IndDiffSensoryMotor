...
if Figure & strcmp(SubNum,'15')
figure
subplot(1,2,1)
hold on; 
bar(Size*1000,squeeze(metrics.PropSacc(exper,subject,:)),'FaceColor',[1 1 1],'EdgeColor','r'); 
hold on; 
plot(Fine_X,Fit_Exp,'-','LineWidth',3,'Color','r')
xlabel('Target Crossing Time [ms]')

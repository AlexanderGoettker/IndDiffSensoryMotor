...
setappdata(D.HRGrid,'PostProcessing','AxisLineWidth');
%--------------------------------------------------------------------------
...
setappdata(D.HTGrid,'PostProcessing','AxisLineWidth');
%--------------------------------------------------------------------------
...
for k=1:D.TTickLabelN % label ticks at theta axis limits
   ...
   D.HTTickLabel(k)=text(xdata,ydata,P.TTickLabel{k},...
      ...
      'Clipping','off',...      
      'HitTest','off');
    setappdata(D.HTTickLabel(k),'FontTemplate','Axis');
end
...
for k=1:D.RTickLabelN
   ...
   D.HRTickLabel(k)=text(xdata,ydata,P.RTickLabel{k},...
      ...
      'Clipping','off',...
      'HitTest','off');
   setappdata(D.HRTickLabel(k),'FontTemplate','Axis');  
end
%--------------------------------------------------------------------------

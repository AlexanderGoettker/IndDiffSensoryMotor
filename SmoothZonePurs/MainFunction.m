...
%% Define Pathway
addpath(genpath('../SmoothZonePurs'))
...
if ismac
    datapath = '/Users/alexandergottker/Dropbox/IndiDiffStudy/Data/SmoothZonePurs/';
    resultpath = '/Users/alexandergottker/Dropbox/IndiDiffStudy/ResultsClean/SmoothZonePurs/';
    Connector = '/';
else
    datapath = 'C:\Users\Alexander Goettker\Dropbox\IndiDiffStudy\Data\SmoothZonePurs\';
    resultpath = 'C:\Users\Alexander Goettker\Dropbox\IndiDiffStudy\ResultsClean\SmoothZonePurs\';
    Connector = '\';
end
...
save([resultpath,'SmoothZonePurs'],'results')
